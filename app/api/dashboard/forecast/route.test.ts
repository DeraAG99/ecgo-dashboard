...
describe("GET /api/dashboard/forecast", () => {
  ...
  it("should return forecast summary with predicted totals", async () => {
    ...
    const res = await GET(new NextRequest("http://localhost/api/dashboard/forecast?days=7"))
  ...
  it("should accept branch filter", async () => {
    ...
    const res = await GET(new NextRequest("http://localhost/api/dashboard/forecast?branch=Kemayoran"))
    expect(res.status).toBe(200)
  ...
  it("should return 400 for invalid days", async () => {
    const res = await GET(new NextRequest("http://localhost/api/dashboard/forecast?days=0"))
  ...
  it("should return 500 on db error", async () => {
    ...
    const res = await GET(new NextRequest("http://localhost/api/dashboard/forecast"))
