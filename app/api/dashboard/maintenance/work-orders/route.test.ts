...
describe("GET /api/dashboard/maintenance/work-orders", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })

  it("should return 400 for invalid query", async () => {
    const res = await GET(new Request("http://localhost/api/dashboard/maintenance/work-orders?status=INVALID") as never)
  ...
  it("should return paginated work orders", async () => {
    ...
    const res = await GET(new Request("http://localhost/api/dashboard/maintenance/work-orders?page=1&limit=20") as never)
...
describe("POST /api/dashboard/maintenance/work-orders", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
